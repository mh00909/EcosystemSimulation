...
QT_MOC_LITERAL(1, 17, 23), // "simulationStepCompleted"
QT_MOC_LITERAL(2, 41, 0) // ""

    },
    "SimulationThread\0simulationStepCompleted\0"
    ""
};
...
void SimulationThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->simulationStepCompleted(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SimulationThread::simulationStepCompleted)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SimulationThread::simulationStepCompleted()
{
